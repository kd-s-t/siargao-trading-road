...
func SeedSuppliers() error {
	...
	suppliers := []struct {
		...
		{"arons@example.com", "Arons", "09123456785", fmt.Sprintf("%s/assets/aronslogo.png", s3BaseURL), fmt.Sprintf("%s/assets/aronsbanner.png", s3BaseURL), "Tourism Road, General Luna, Surigao del Norte", floatPtr(9.8404527), floatPtr(126.1356772), "", "", "", "", "", "", "", "Monday-Friday", "08:00", "18:00"},
